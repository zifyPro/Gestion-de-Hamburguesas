...
<div className="mx-auto bg-black rounded-xl shadow-md overflow-hidden w-[92vw] m-4 h-32 md:w-11/12">
  <div className="flex">
    ...
    <div className="-ml-20 w-35">
      <div className="uppercase tracking-wide text-gray-text font-semibold w-32 relative  text-lg text-nowrap	" >{product?.title}</div>
    ...
    <div className="mt-10 -ml-[15vw] ">
      <div className="text-lg font-bold text-white sm:-mt-[6vh] -mt-[4.5vh] -ml-[7vh]  md:-mt-[3vh]">{"$"+product?.price}</div>

...
<div class="mx-auto bg-custom-gray rounded-xl shadow-md overflow-hidden w-11/12 m-5 h-32">
  <div class="flex">
    ...
    <div class="-ml-20">
      <div class="uppercase tracking-wide text-sm text-gray-text font-semibold w-32 relative  text-lg " >{product?.title}</div>
      <p class="mt-2 text-gray-500  ">{product?.description}</p>
      <a href="#" class="block text-lg leading-tight font-medium text-yellow-500 hover:underline -mt-1">Leer más</a>
    </div>
    <div class="p-2 mt-7">
